...
#    self.fontseldiag.apply_button.show()
  ...
  def context_menu(self, data, event_button, event_time,*args):
    self.menu.popup(None, None, None, event_button, event_time, Gtk.get_current_event_time())
...
#    self.statusicon.set_blinking(True)
  ...
  def display_help(self, w):
    ...
    dialog = Gtk.Dialog(None,None,Gtk.DialogFlags.DESTROY_WITH_PARENT,('close',1))
